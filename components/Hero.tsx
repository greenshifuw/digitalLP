...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 bg-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800/80 border border-slate-700 text-sky-200 text-xs font-medium tracking-wide mb-8 uppercase">
            <Layers size={14} />
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-8 leading-tight">
            Pilotez votre conformité globale <br className="hidden md:block" />
            <span className="text-sky-300">du DUERP à la gestion des déchets.</span>
          </h1>
          
          <p className="mt-4 max-w-2xl mx-auto text-xl text-slate-300 font-light mb-10 leading-relaxed">
          ...
          <p className="mt-8 text-sm text-sky-400/80 font-medium">
